...
import { Navbar, Link, Text, Avatar,  Dropdown, Card, Grid} from "@nextui-org/react";
import { icons } from "../../components/Icons";
import Tarjetas from '../../components/Card';
...
const AboutPage = () => {
    ...
    <div className="educacion">
        ...
        <div>
            ...
            <Grid xs={6} sm={6}>
            <Card css={{ p: "$6", mw: "400px", ml:"$18", mt:"$10" }}>
            <Card.Header>
                <img
                alt="logo"
                src="https://4.bp.blogspot.com/-CWNG4yZPpAY/XEyeYM5X8PI/AAAAAAAAA7c/ysMme5mdzLshq5dCsVhH91JKoedZOCSyQCLcBGAs/s1600/tanti.png"
                width="116px"
                height="96px"
                />
                ...
                <Grid xs={12}>
                    <Text css={{ color: "$accents8" }}>Instituto San José</Text>
                </Grid>
                </Grid.Container>
            </Card.Header>
            <Card.Body css={{ py: "$2" }}>
            ...
            <Card.Header>
                ...
                <Grid xs={12}>
                    <Text css={{ color: "$accents8" }}>Instituto Remedios Escalada de San Martín</Text>
                </Grid>
                </Grid.Container>
            </Card.Header>
            <Card.Body css={{ py: "$2" }}>
